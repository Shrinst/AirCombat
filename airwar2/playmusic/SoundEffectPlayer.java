 ...
 *
 */
public class SoundEffectPlayer implements LineListener {
	...
	/**
	 * Will set the sound effect to be played
	 * 
	 * @param fileName
	 *            the sound effect location
	 */
	public SoundEffectPlayer(String fileName) {
		try {
			audioInputStream = AudioSystem
					.getAudioInputStream(this.getClass().getResource("/airwar2/soundeffects/" + fileName + ".wav"));
	 ...
	 * 
	 * @param volume
	 *            how louder will the sound effects will sound
	 */
