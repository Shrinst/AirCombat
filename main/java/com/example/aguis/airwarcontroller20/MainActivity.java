...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    private Button btnShoot, btnPowerUp;
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        String msg = "";
        if (shootFlag) {
            msg +=  String.valueOf(X_AXIS) + ";" + String.valueOf(Y_AXIS) + ";" + "shooting" + ";" + "null";
        } else if (powerUpFlag) {
            msg +=  String.valueOf(X_AXIS) + ";" + String.valueOf(Y_AXIS) + ";" + "shooting" + ";" + "powerup";
        } else {
            msg +=  String.valueOf(X_AXIS) + ";" + String.valueOf(Y_AXIS) + ";" + "null" + "null";
        }
